        ...
        switch(cchoice){
            ...
            case 4: generateBill(cart.head);
                    for(int index = 0; index < 100; index++)
                        cout<<"_";
                        cout<<"\n ";
                        cout<<"\nPlease Receive Bill From the Counter!!!";
                        cout<<"\n ";
...
int main() {
    init();
    int choice = 0;
    string header = "_________________________________________________";
    string line1 = "|                                                 |";
    string line2 = "|                  SZABIST MART                   |";
    string line3 = "|_________________________________________________|";
    cout << string( (80 - header.length()) / 2, ' ') << header << endl;
    cout << string( (80 - line1.length()) / 2, ' ') << line1 << endl;
    cout << string( (80 - line1.length()) / 2, ' ') << line1 << endl;
    cout << string( (80 - line2.length()) / 2, ' ') << line2 << endl;
    cout << string( (80 - line1.length()) / 2, ' ') << line1 << endl;
    cout << string( (80 - line3.length()) / 2, ' ') << line3 << endl;

    do {
        for(int index = 0; index < 100; index++)
            cout<<"_";
            cout<<"\n ";
        cout<<"\n| 1. I am a Vendor | 2. I am a Customer | 3. Exit |"<<endl;
        for(int index = 0; index < 100; index++)
            cout<<"_";
        cout<<"\nEnter your Choice: ";
        cin>>choice;
